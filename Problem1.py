#Find the percentage of patience that survived beyond five years after simulating a single cohort
...
class Cohort:
    ...
    def simulate(self, n_time_steps):
        ...
        for patient in self._patients:
            ...
            if not (value is None):
                ...
                if value <5:
                    self._five_year_survival.append(0)
                else:
                    self._five_year_survival.append(1)
    ...
    def get_five_year_survival(self):
        return self._five_year_survival
...
class CohortOutcomes:
    ...
    def get_five_year_survival(self):
        return self._simulatedCohort.get_five_year_survival()
...
simulation = Cohort(id=1, pop_size=1000, mortality_prob=.1)
sim=simulation.simulate(50)
print(sum(sim.get_five_year_survival())/1000)
