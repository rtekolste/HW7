...
import Problem1 as SurvivalCls
    ...
    def sample_posterior(self):
        ...
        for cohort_id in self._cohortIDs:
            ...
            weight = stat.binom.pmf(
                k=CalibSets.OBS_FIVE_YEAR_RATE,
                n=CalibSets.OBS_N,
                p=fiveyearrate)
...
print('Mortality Probability Estimate({:.{prec}%} and interval):'.format(1-CalibSets.ALPHA, prec=0),
...
print('Mean survival and {:.{prec}%} projection interval:'.format(1 - CalibSets.ALPHA, prec=0),
